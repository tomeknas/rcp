...
(function (jQuery) {
	...
	var Chart = function(div, opts) {
        ...
        function addVtHeader(div, data, cellHeight) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                for (var j = 0; j < data[i].series.length; j++) {
                    var startDate = data[i].series[j].start;
                    var endDate = data[i].series[j].end;
                    seriesDiv.append(jQuery("<div>", { "class": "ganttview-vtheader-series-name" })
					//.append(data[i].series[j].name));
                                        //        .append(data[i].series[j].start));
                                                .append(startDate.getFullYear() + "-" + (startDate.getMonth() + 1) + "-" + startDate.getDate())
                                                //.append("<br>")
                                                .append(" - ")
                                                .append(endDate.getFullYear() + "-" + (endDate.getMonth() + 1) + "-" + endDate.getDate()));
                }
        ...
        function addBlocks(div, data, cellWidth, start) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    block.append(jQuery("<div>", { "class": "ganttview-block-text" }).text(data[i].progress + "%"));
        ...
        function addBlockData(block, data, series) {
        	...
        	var blockData = { id: data.id, name: data.name, progress: data.progress };
